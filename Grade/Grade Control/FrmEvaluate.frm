...
Private Sub cmdEva_Click()
    ...
    For i = 1 To 180
        If Terms(TId).Table_Class(i) = True Then
            ...
            If Grades(GId).All <> 0 Then
                GradeTemp = Grades(GId).Get / Grades(GId).All + Grades(GId).AveClass * 0.001 + Grades(GId).AveGroup * 0.002
            Else
                GradeTemp = 0
            End If
...
Private Sub Form_Load()
    ...
    ACPRibbon1.Caption = "Evaluate from Data."
